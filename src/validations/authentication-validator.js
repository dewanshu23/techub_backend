...
const userAccountSignupSchema = Joi.object({
  ...
  userRole: Joi.string().valid("Student", "Alumni", "Admin").required(),
  passout: Joi.number().max(2023).required(),
  year: Joi.string().valid("First Year","Second Year", "Third Year",).required(),
});
